package trading.books;

import trading.carriers.MatcherFlyweightOrderRef;
import trading.carriers.RestingOrder;
...
public class PooledRedBlackTreeOrderBook implements OrderBook {
    ...
    public PooledRedBlackTreeOrderBook(int maxOrders, int maxPriceLevels) {
    ...
    public PooledRedBlackTreeOrderBook() {
        this(100_000, 2_000);
    }
